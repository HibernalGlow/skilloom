...
- **Mermaid 的语义触发**: use it for procedures, sequences, branches, comparisons, or subject relationships. Choose the diagram that explains the actual material; never generate a fixed list of headings merely to satisfy the rule.
