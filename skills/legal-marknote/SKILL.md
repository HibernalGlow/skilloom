...
- **Audit**: run the MarkNote validator in strict mode, fix every E620-E627 finding, and review `W503` concept-list monotony plus `W504` paragraph-parent fragmentation before delivery.
