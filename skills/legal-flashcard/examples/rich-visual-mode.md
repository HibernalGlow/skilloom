...
- 人数不确定的代表人诉讼启动步骤是什么？ #法考/民诉/共同诉讼/代表人诉讼/人数不确定# #闪卡/优先级/P1#
    - 程序步骤：
        ...
        3. 由登记的权利人**推选代表人**{: style="color: var(--b3-font-color8);"}；推选不出时，由法院与登记权利人**商定**{: style="background-color: var(--b3-font-background13);"}。
        ```mermaid
        flowchart LR
            A[人数尚未确定] --> B[公告案件情况]
            B --> C[权利人登记]
...
- **区分口诀**{: style="color: var(--b3-font-color6);"}：==必要共标的，普通同种类；确定全体推，不定公告登。== #法考/民诉/共同诉讼/区分口诀# #闪卡/优先级/P1#
    ...
    - ==不定公告登==：人数不确定时先公告、登记，再**推选或商定**{: style="background-color: var(--b3-font-background13);"}代表人。
