...
- **绝对归国家所有**{: style="color: var(--b3-font-color10);"}的资源口诀：==国有城土海水矿== #法考/理论法/宪法/资源归属口诀# #闪卡/优先级/P1#
    - 原文：==国有==**城土**{: style="color: var(--b3-font-color8);"}==海水矿==。
    - ==城土==：**城市土地**{: style="color: var(--b3-font-color12);"}。
    - ==海水矿==：**海域**{: style="color: var(--b3-font-color5);"}、水流、矿藏。
...
report:
  ...
  rejection_reasons: {}
source:
  note: "客观/02-背诵卷/理论法/2026-马峰/20-整理/02-考点31-基本经济制度"
