...
- 立法的三大**基本原则**{: style="color: var(--b3-font-color12);"}是什么？ #法考/理论法/立法法/基本原则# #闪卡/优先级/P1#
    - **科学性原则**{: style="color: var(--b3-font-color10);"}：立法符合客观规律。
    - **民主性原则**{: style="color: var(--b3-font-color8);"}：立法反映人民意志。
    - **合法性原则**{: style="color: var(--b3-font-color13);"}：立法权限和程序符合法律。
...
report:
  ...
  rejection_reasons: {}
source:
  note: "客观/02-背诵卷/理论法/2026-马峰/20-整理/01-考点23-立法法"
