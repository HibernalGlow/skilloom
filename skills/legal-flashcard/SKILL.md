...
- Emit the final generation report as one parseable YAML fenced block (`report.candidates`, `report.accepted`, `report.rejected`, `report.rejection_reasons`), never as a prose count sentence.
